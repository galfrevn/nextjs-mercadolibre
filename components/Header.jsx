    ...
    <>
      <header className="w-full bg-[#ffe600] sticky top-0 z-50 px-2.5 py-2 border-b-[0.1px] border-[#dfcf3e] ">
        <div className="max-w-2xl mx-auto flex justify-between">
          ...
          <SearchBar />
          <div>
            <div className="pl-1 flex justify-center items-center space-x-2">
              <Popover className="">
                {({ open }) => (
                  <>
                    <Popover.Button
                      ...
                      <Popover.Panel className="absolute left-4 z-10 -ml-4 mt-2.5 transform w-screen">
                        <div className=" shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden bg-white">
                          ...
                          <div className="flex justify-between px-5 space-x-1 pb-4 border-b mt-2">
                            <button className="text-xs w-full font-medium text-white bg-blue-500 rounded-md py-3" >Ingresá</button>
                            <button className="text-xs w-full font-medium text-blue-500 border border-blue-500 py-3 rounded-md" >Creá tu cuenta</button>
                          </div>

  ...
  return (
    <div>
      <div>
        ...
        <div className="bg-white grid grid-cols-2 px-8 pb-8 pt-3 text-sm text-gray-600 space-y-4 border-b">
        ...
        <div className="bg-white px-8 pb-8">
          <p className="text-xs text-gray-400 mb-2" > © 1999-2022 MercadoLibre S.R.L.</p>
          <p className="text-xs text-gray-400" >Av. Caseros 3039, Piso 2, CP 1264, Parque Patricios, CABA</p>
        </div>
